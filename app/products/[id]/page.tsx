...
export async function generateMetadata({
  ...
  return {
    title: product.name,
    description: product.description || `${product.name} - Diseño único de lettering`,
    openGraph: {
...
export default async function ProductDetailsPage({
  ...
  const totalStock = product.product_colors.reduce((sum, c) => sum + c.stock, 0);
          ...
          <Card className="overflow-hidden">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <CardContent className="p-8 space-y-6">
                ...
                <ProductColorSelector productColors={product.product_colors} />
              </CardContent>
            </div>
          </Card>
